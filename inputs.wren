...
BASIC.register("confirm", [ Keyboard["return"], Keyboard["keypad enter"] ])
BASIC.register("easyConfirm", [ Keyboard["return"], Keyboard["space"], Keyboard["keypad enter"] ])
...
BASIC.register("lexicon", [ Keyboard["g"] ])
